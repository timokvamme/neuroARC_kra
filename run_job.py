...
subject_id = "0007"  # Change this ID as needed
...
job_id = submit_job(subject_id, log_out_template, log_err_template, script_path, scratch_dir, email="timo@cfin.au.dk")
...
script_path = "/projects/2022_MR-SensCogGlobal/scripts/neuroARC_kra/mrtrix_pipeline_step_4.sh"
job_id =  submit_job(subject_id, log_out_template, log_err_template, script_path, scratch_dir, email="timo@cfin.au.dk")
if job_id: wait_for_job_completion(job_id,check_interval=check_interval)
